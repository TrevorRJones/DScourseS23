...
#   occupation: Tech-support, Craft-repair, Other-serve, Sales, Exec-managerial, Prof-specialty, Handlers-cleaners, Machine-op-inspct, Adm-clerical, Farming-fishing, Transport-moving, Priv-house-serv, Protective-serv, Armed-Forces.
...
final_svm_lasso <- finalize_workflow(rec_wf_svm,
                                     best_acc_svm
)
print('*********** SVM **************')
svm_test <- last_fit(final_svm_lasso,income_split) %>%
  collect_metrics()
